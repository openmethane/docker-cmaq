C        From TAPENADE     (INRIA, Tropics team)
C  Tapenade 3.5 (r3442) - 27 Apr 2010 10:01
C
C  This file is from ADFirstAidKit in the TAPENADE pushpop.tar.gz file

C$Id: adBuffer.f,v 1.3 2011/04/06 23:47:17 ppercell Exp $
