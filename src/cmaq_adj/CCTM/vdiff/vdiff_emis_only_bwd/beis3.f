...
C $Header: /Volumes/Data/CVS/CMAQ_CVSrepos/CCTM/src/vdiff/acm2_inline_adj_fwd/beis3.f,v 1.1 2011/02/22 01:10:45 ppercell Exp $
...
C              System
C File: @(#)$Id: beis3.f,v 1.1 2011/02/22 01:10:45 ppercell Exp $
...
C smoke@unc.edu
C Pathname: $Source: /Volumes/Data/CVS/CMAQ_CVSrepos/CCTM/src/vdiff/acm2_inline_adj_fwd/beis3.f,v $
