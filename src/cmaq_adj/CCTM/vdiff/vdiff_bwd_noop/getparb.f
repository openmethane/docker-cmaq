...
C $Header: /Volumes/Data/CVS/CMAQ_CVSrepos/CCTM/src/vdiff/acm2_inline_adj_fwd/getparb.f,v 1.1 2011/02/22 01:10:45 ppercell Exp $
...
C File: @(#)$Id: getparb.f,v 1.1 2011/02/22 01:10:45 ppercell Exp $
...
C smoke@unc.edu
C Pathname: $Source: /Volumes/Data/CVS/CMAQ_CVSrepos/CCTM/src/vdiff/acm2_inline_adj_fwd/getparb.f,v $
