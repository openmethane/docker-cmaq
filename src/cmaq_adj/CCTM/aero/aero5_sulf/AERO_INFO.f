...
C $Header: /Volumes/Data/CVS/CMAQ_CVSrepos/CCTM/src/aero/aero5_sulf/AERO_INFO.f,v 1.1.1.1 2010/06/14 16:03:00 sjr Exp $
...
c *** indices for sulfur tracking in the CBLK array
      ...
      INTEGER   VSO4AJAQH2O2 ! accumulation mode sulfate from aq rxn AQH2O2

      INTEGER   VSO4AJAQO3   ! accumulation mode sulfate from aq rxn AQO3

      INTEGER   VSO4AJAQFEMN ! accumulation mode sulfate from aq rxn AQFEMN

      INTEGER   VSO4AJAQMHP  ! accumulation mode sulfate from aq rxn AQMHP

      INTEGER   VSO4AJAQPAA  ! accumulation mode sulfate from aq rxn AQPAA

      INTEGER   VSO4AIGAS    ! Aitken mode sulfate from gas-phase production

      INTEGER   VSO4AJGAS    ! accumulation mode sulfate from gas-phase prod.

      INTEGER   VSO4AKGAS    ! coarse mode sulfate from gas-phase production

      INTEGER   VSO4AIEMIS   ! Aitken mode sulfate from direct emissions

      INTEGER   VSO4AJEMIS   ! accumulation mode sulfate from direct emissions

      INTEGER   VSO4AKEMIS   ! coarse mode sulfate from direct emissions

      INTEGER   VSO4AIICBC   ! Aitken mode sulfate from ICs/BCs

      INTEGER   VSO4AJICBC   ! accumulation mode sulfate from ICs/BCs

      INTEGER   VSO4AKICBC   ! coarse mode sulfate from ICs/BCs
