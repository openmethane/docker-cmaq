...
C $Header: /Volumes/Data/CVS/CMAQ_CVSrepos/CCTM/src/aero/aero5_txhg/AERO_INFO.f,v 1.1.1.1 2010/06/14 16:03:00 sjr Exp $
...
C *** indices for mercuric aerosols (WTH)

      LOGICAL, SAVE :: MERCURY_MECH !  flag for mercuric aerosols

      INTEGER   VPHGI     !  Aitken mode mercury concentration
      INTEGER   VPHGJ     !  Accum  mode mercury concentration
...
C...component densities [ kg/m**3 ]
      ...
      REAL        RHOPHG   ! bulk density for mercury aerosol
      PARAMETER ( RHOPHG = 8.0e3 )  ! an average value for divalent mercury compounds
...
C...   to 3rd moment concentration [ m**3 m^-3]
      ...
      REAL        PHGFAC
      PARAMETER ( PHGFAC  = F6DPIM9 / RHOPHG )
