...
C $Header: /Volumes/Data/CVS/CMAQ_CVSrepos/CCTM/src/aero/aero5_carb/AERO_INFO.f,v 1.1.1.1 2010/06/14 16:02:59 sjr Exp $
...
C    Revised 10/05/09 by Sergey L. Napelenok to add species for apportionment of primary OC & EC
...
C sln - Source-specific primary carbon species
         INTEGER, DIMENSION(15) :: VORGPJIND, VORGPIIND, VECJIND, VECIIND
...
C *** Calculate aerosol 3rd moment concentrations [ m**3 / m**3 ]
     ...
     &         NO3FAC  * CBLK(  VNO3AI)  +
     &         ORGFAC  * CBLK(  VORGPAI) +
     &         ORGFAC  * CBLK(  VORGPIIND(1) ) +
     &         ORGFAC  * CBLK(  VORGPIIND(2) ) +
     &         ORGFAC  * CBLK(  VORGPIIND(3) ) +
     &         ORGFAC  * CBLK(  VORGPIIND(4) ) +
     &         ORGFAC  * CBLK(  VORGPIIND(5) ) +
     &         ORGFAC  * CBLK(  VORGPIIND(6) ) +
     &         ORGFAC  * CBLK(  VORGPIIND(7) ) +
     &         ORGFAC  * CBLK(  VORGPIIND(8) ) +
     &         ORGFAC  * CBLK(  VORGPIIND(9) ) +
     &         ORGFAC  * CBLK(  VORGPIIND(10) ) +
     &         ORGFAC  * CBLK(  VORGPIIND(11) ) +
     &         ORGFAC  * CBLK(  VORGPIIND(12) ) +
     &         ORGFAC  * CBLK(  VORGPIIND(13) ) +
     &         ORGFAC  * CBLK(  VORGPIIND(14) ) +
     &         ORGFAC  * CBLK(  VORGPIIND(15) ) +
     &         ANTHFAC * CBLK(  VP25AI) +
     &         ANTHFAC * CBLK(  VECI) +
     &         ANTHFAC * CBLK(  VECIIND(1) ) +
     &         ANTHFAC * CBLK(  VECIIND(2) ) +
     &         ANTHFAC * CBLK(  VECIIND(3) ) +
     &         ANTHFAC * CBLK(  VECIIND(4) ) +
     &         ANTHFAC * CBLK(  VECIIND(5) ) +
     &         ANTHFAC * CBLK(  VECIIND(6) ) +
     &         ANTHFAC * CBLK(  VECIIND(7) ) +
     &         ANTHFAC * CBLK(  VECIIND(8) ) +
     &         ANTHFAC * CBLK(  VECIIND(9) ) +
     &         ANTHFAC * CBLK(  VECIIND(10) ) +
     &         ANTHFAC * CBLK(  VECIIND(11) ) +
     &         ANTHFAC * CBLK(  VECIIND(12) ) +
     &         ANTHFAC * CBLK(  VECIIND(13) ) +
     &         ANTHFAC * CBLK(  VECIIND(14) ) +
     &         ANTHFAC * CBLK(  VECIIND(15) ) +
     &         SEASFAC * CBLK(  VNAI) +
     &         SEASFAC * CBLK(  VCLI) ) )
     ...
     &         NO3FAC  * CBLK(  VNO3AJ)   +
     &         ORGFAC  * CBLK(  VORGPAJ)  +
     &         ORGFAC  * CBLK(  VORGPJIND(1) ) +
     &         ORGFAC  * CBLK(  VORGPJIND(2) ) +
     &         ORGFAC  * CBLK(  VORGPJIND(3) ) +
     &         ORGFAC  * CBLK(  VORGPJIND(4) ) +
     &         ORGFAC  * CBLK(  VORGPJIND(5) ) +
     &         ORGFAC  * CBLK(  VORGPJIND(6) ) +
     &         ORGFAC  * CBLK(  VORGPJIND(7) ) +
     &         ORGFAC  * CBLK(  VORGPJIND(8) ) +
     &         ORGFAC  * CBLK(  VORGPJIND(9) ) +
     &         ORGFAC  * CBLK(  VORGPJIND(10) ) +
     &         ORGFAC  * CBLK(  VORGPJIND(11) ) +
     &         ORGFAC  * CBLK(  VORGPJIND(12) ) +
     &         ORGFAC  * CBLK(  VORGPJIND(13) ) +
     &         ORGFAC  * CBLK(  VORGPJIND(14) ) +
     &         ORGFAC  * CBLK(  VORGPJIND(15) ) +
     &         ORGFAC  * CBLK(  VXYL3J)  +
     &         ORGFAC  * CBLK(  VTOL3J)  +
     &         ORGFAC  * CBLK(  VBNZ3J)  +
     &         ORGFAC  * CBLK(  VISO3J)  +
     ...
     &         ANTHFAC * CBLK(  VP25AJ)  +
     &         ANTHFAC * CBLK(  VECJ) +
     &         ANTHFAC * CBLK(  VECJIND(1) ) +
     &         ANTHFAC * CBLK(  VECJIND(2) ) +
     &         ANTHFAC * CBLK(  VECJIND(3) ) +
     &         ANTHFAC * CBLK(  VECJIND(4) ) +
     &         ANTHFAC * CBLK(  VECJIND(5) ) +
     &         ANTHFAC * CBLK(  VECJIND(6) ) +
     &         ANTHFAC * CBLK(  VECJIND(7) ) +
     &         ANTHFAC * CBLK(  VECJIND(8) ) +
     &         ANTHFAC * CBLK(  VECJIND(9) ) +
     &         ANTHFAC * CBLK(  VECJIND(10) ) +
     &         ANTHFAC * CBLK(  VECJIND(11) ) +
     &         ANTHFAC * CBLK(  VECJIND(12) ) +
     &         ANTHFAC * CBLK(  VECJIND(13) ) +
     &         ANTHFAC * CBLK(  VECJIND(14) ) +
     &         ANTHFAC * CBLK(  VECJIND(15) ) +
     &         SEASFAC * CBLK(  VNAJ) +
     &         SEASFAC * CBLK(  VCLJ) )   )
