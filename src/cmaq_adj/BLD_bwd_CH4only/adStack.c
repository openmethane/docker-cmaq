/*       From TAPENADE     (INRIA, Tropics team)
 * Tapenade 3.5 (r3442) - 27 Apr 2010 10:01
 *
 * This file is from ADFirstAidKit in the TAPENADE pushpop.tar.gz file */

static char adSid[]="$Id: adStack.c,v 1.4 2011/04/06 23:47:17 ppercell Exp $";
