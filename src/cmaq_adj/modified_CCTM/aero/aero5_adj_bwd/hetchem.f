...
C $Header: /Volumes/Data/CVS/CMAQ_CVSrepos/CCTM/src/aero/aero5_adj_bwd/hetchem.f,v 1.1 2010/11/18 14:51:26 sergey Exp $
...
c //////////////////////////////////////////////////////////////////////
c  FUNCTION IRHX determines whether the ambient RH has exceeded the RH
c    of ice formation, based on the Goff-Gratch equations as given by 
c    List (1984).
c
c  REFERENCES:
