...
!:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
      SUBROUTINE GETCOAGS_ADJ  ( LAMDA, KFMATAC, KFMATAC_ADJ, KFMAT,
     &                         KFMAT_ADJ, KFMAC, KFMAC_ADJ, KNC,
     &                         DGATK, DGATK_ADJ, DGACC, DGACC_ADJ,
     &                         SGATK, SGACC, XXLSGAT, XXLSGAT_ADJ,
     &                         XXLSGAC, XXLSGAC_ADJ, QS11, QS11_ADJ,
     &                         QN11, QN11_ADJ, QS22, QS22_ADJ, QN22,
     &                         QN22_ADJ, QS12, QS12_ADJ, QS21, QS21_ADJ,
     &                         QN12, QN12_ADJ, QV12, QV12_ADJ )

!-----------------------------------------------------------------------
! Function:
!   Adjoint of subroutine that calculates the coagulation rates using 
!   a new approximate algorithm for the 2nd moment.  The 0th and 3rd
!   moments are done by analytic expressoins from Whitby et al. (1991).
!
! INPUTS:
!   LAMDA, KFMATAC, KFMAT, KFMAC, KNC, DGATK, DGACC, SGATK, SGACC,
!   XXLSGAT, XXLSGAC, QS11_ADJ, QN11_ADJ, QS22_ADJ, QN22_ADJ,
!   QS12_ADJ, QS21_ADJ, QN12_ADJ, QV12_ADJ
!
! OUTPUTS:
!   KFMATAC_ADJ, KFMAT_ADJ, KFMAC_ADJ, DGATK_ADJ, DGACC_ADJ, 
!   XXLSGAT_ADJ, XXLSGAC_ADJ
!
! Revision History:
...
! *** Adjoint variables
      ...
      REAL*8     QS12, QS21, QN12, QV12
      REAL*8     QS11_ADJ
      REAL*8     QN11_ADJ, QS22_ADJ, QN22_ADJ
      REAL*8     QS12_ADJ, QS21_ADJ, QN12_ADJ, QV12_ADJ
      REAL*8     N1_ADJ
      REAL*8     N2A_ADJ
      REAL*8     N2N_ADJ
      REAL*8     I1FM_AT_ADJ
      ...
      REAL*8     ESAC64_ADJ
      REAL*8     ESAT100_ADJ
      REAL*8     DGAT2_ADJ, DGAC2_ADJ
      REAL*8     DGAT3_ADJ, DGAC3_ADJ
      REAL*8     SQDGAT_ADJ, SQDGAC_ADJ
      REAL*8     SQDGAT5_ADJ, SQDGAC5_ADJ
      REAL*8     SQDGAT7_ADJ
      REAL*8     R_ADJ, R2_ADJ, R3_ADJ, R4_ADJ, R5_ADJ, R6_ADJ, R8_ADJ
      REAL*8     RI1_ADJ, RI2_ADJ, RI3_ADJ, RI4_ADJ
      REAL*8     RAT_ADJ
      REAL*8     COAGFM0_ADJ, COAGNC0_ADJ
      REAL*8     COAGFM3_ADJ, COAGNC3_ADJ
      REAL*8     COAGFM_AT_ADJ, COAGFM_AC_ADJ
      REAL*8     COAGNC_AT_ADJ, COAGNC_AC_ADJ
      REAL*8     COAGATAT0_ADJ
      REAL*8     COAGACAC0_ADJ
      REAL*8     COAGATAT2_ADJ
      REAL*8     COAGACAC2_ADJ
      REAL*8     COAGATAC0_ADJ, COAGATAC3_ADJ
      REAL*8     COAGATAC2_ADJ
      REAL*8     COAGACAT2_ADJ
      REAL*8     XM2AT_ADJ, XM3AT_ADJ, XM2AC_ADJ, XM3AC_ADJ
...
! Adjoint code:
      ...
      ! COAGACAC2 = CONSTII * I1_AC
      ! adj code:
      I1_AC_ADJ = I1_AC_ADJ + CONSTII * COAGACAC2_ADJ
      COAGACAC2_ADJ = 0.0
      ...
      ! QS22 = COAGACAC2 * BM2IITT(N2A)
      ! adj code:
      COAGACAC2_ADJ = COAGACAC2_ADJ + BM2IITT(N2A) * QS22_ADJ
      IF ( N2A > 1 .AND. N2A < 10 ) THEN
         N2A_ADJ = N2A_ADJ + COAGACAC2 * ( ( BM2IITT( N2A + 1 )
     &            )- BM2IITT( N2A - 1 ) ) / 2.0 * QS22_ADJ
      ELSE IF ( N2A == 1 ) THEN
         N2A_ADJ = N2A_ADJ + COAGACAC2 * ( BM2IITT( N2A + 1 )
     &           - BM2IITT( N2A ) ) * QS22_ADJ
      ELSE IF ( N2A == 10 ) THEN
         N2A_ADJ = N2A_ADJ + COAGACAC2 * ( BM2IITT( N2A )
     &           - BM2IITT( N2A - 1) ) * QS22_ADJ
      END IF
      QS22_ADJ = 0.0
      ...
      ! I1_AC = ( I1NC_AC * I1FM_AC ) / ( I1NC_AC + I1FM_AC )
      ! adj code:
      I1NC_AC_ADJ = I1NC_AC_ADJ + ( I1FM_AC / ( I1NC_AC + I1FM_AC )
     &            - I1FM_AC * I1NC_AC / ( I1NC_AC + I1FM_AC ) ** 2.0 )
     &            * I1_AC_ADJ
      I1FM_AC_ADJ = I1FM_AC_ADJ + ( I1NC_AC / ( I1NC_AC + I1FM_AC )
     &            - I1FM_AC * I1NC_AC / ( I1NC_AC + I1FM_AC ) ** 2.0 )
     &            * I1_AC_ADJ
      I1_AC_ADJ = 0.0
      ...
      ! &      +  ESAC16 * ESAC01  )
      ! adj code:
      KFMAC_ADJ = KFMAC_ADJ + BM2II(N2A) * SQDGAC5 * ( ESAC25
     &          +  TWO * ESAC09 * ESAC04
     &          +  ESAC01 * ESAC16
     &          +  ESAC64 * ESAC09
     &          +  TWO * ESAC36 * ESAC01
     &          +  ESAC16 * ESAC01  ) * I1FM_AC_ADJ
      SQDGAC5_ADJ = SQDGAC5_ADJ + BM2II(N2A) * KFMAC * ( ESAC25
     &          +  TWO * ESAC09 * ESAC04
     &          +  ESAC01 * ESAC16
     &          +  ESAC64 * ESAC09
     &          +  TWO * ESAC36 * ESAC01
     &          +  ESAC16 * ESAC01  ) * I1FM_AC_ADJ
      ESAC25_ADJ = ESAC25_ADJ + KFMAC * SQDGAC5 * BM2II(N2A) * 
     &             I1FM_AC_ADJ
      ESAC04_ADJ = ESAC04_ADJ + KFMAC * SQDGAC5 * BM2II(N2A)
     &           * TWO * ESAC09 * I1FM_AC_ADJ
      ESAC09_ADJ = ESAC09_ADJ + KFMAC * SQDGAC5 * BM2II(N2A)
     &           * ( TWO * ESAC04 + ESAC64 ) * I1FM_AC_ADJ
      ESAC16_ADJ = ESAC16_ADJ + KFMAC * SQDGAC5 * BM2II(N2A)
     &           * 2.0 * ESAC01 * I1FM_AC_ADJ
      ESAC01_ADJ = ESAC01_ADJ + KFMAC * SQDGAC5 * BM2II(N2A)
     &           * ( 2.0 * ESAC16 + TWO * ESAC36 ) * I1FM_AC_ADJ
      ESAC64_ADJ = ESAC64_ADJ + KFMAC * SQDGAC5 * BM2II(N2A)
     &           * ESAC09 * I1FM_AC_ADJ
      ESAC36_ADJ = ESAC36_ADJ + KFMAC * SQDGAC5 * BM2II(N2A)
     &           * TWO * ESAC01 * I1FM_AC_ADJ
      IF ( N2A > 1 .AND. N2A < 10 ) THEN
         N2A_ADJ = N2A_ADJ + KFMAC * SQDGAC5 * ( ESAC25
     &             +  TWO * ESAC09 * ESAC04
     &             +  ESAC01 * ESAC16
     &             +  ESAC64 * ESAC09
     &             +  TWO * ESAC36 * ESAC01
     &             +  ESAC16 * ESAC01 ) * ( ( BM2II( N2A + 1 )
     &             - BM2II( N2A - 1 ) ) / 2.0 ) * I1FM_AC_ADJ
      ELSE IF ( N2A == 1 ) THEN
         N2A_ADJ = N2A_ADJ + KFMAC * SQDGAC5 * ( ESAC25
     &             +  TWO * ESAC09 * ESAC04
     &             +  ESAC01 * ESAC16
     ...
     &             +  ESAC64 * ESAC09
     &             +  TWO * ESAC36 * ESAC01
     &             +  ESAC16 * ESAC01 ) * ( BM2II( N2A )
     &             - BM2II( N2A - 1 ) ) * I1FM_AC_ADJ
      END IF
      I1FM_AC_ADJ = 0.0
      ...
      ! &     +     ESAC36 * ESAC16 )  )
      ! adj code:
      DGAC2_ADJ = DGAC2_ADJ + KNC * ( TWO * ESAC16 + ESAC04 * ESAC04
     &          + ESAC36 * ESAC04 + A * KNGAC * ( TWO * ESAC04
     &          + ESAC16 * ESAC04 + ESAC36 * ESAC16 ) ) * I1NC_AC_ADJ
      ESAC16_ADJ = ESAC16_ADJ + ( KNC * DGAC2 * TWO + KNC * DGAC2 * A
     &           * KNGAC * ( ESAC04 + ESAC36 ) ) * I1NC_AC_ADJ
      ESAC04_ADJ = ESAC04_ADJ + KNC * DGAC2 * ( 2.0 * ESAC04 + ESAC36 )
     &           + KNC * DGAC2 * A * KNGAC * ( TWO + ESAC16 ) * 
     &           I1NC_AC_ADJ
      ESAC36_ADJ = ESAC36_ADJ + KNC * DGAC2 * ESAC04 + KNC * DGAC2
     &           * A * KNGAC * ESAC16 * I1NC_AC_ADJ
      KNGAC_ADJ = KNGAC_ADJ + KNC * DGAC2 * A * ( TWO * ESAC04
     &          + ESAC16 * ESAC04 + ESAC36 * ESAC16 ) * I1NC_AC_ADJ
      I1NC_AC_ADJ = 0.0
      ...
      ! QS11 = COAGATAT2 * BM2IITT(N2N)
      ! adj code:
      COAGATAT2_ADJ = COAGATAT2_ADJ + BM2IITT(N2N) * QS11_ADJ
      IF ( N2N > 1 .AND. N2N < 10 ) THEN
         N2N_ADJ = N2N_ADJ + COAGATAT2 * ( BM2IITT( N2N + 1 )
     &           - BM2IITT( N2N - 1 ) / 2.0 ) * QS11_ADJ
      ELSE IF ( N2N == 1 ) THEN
         N2N_ADJ = N2N_ADJ + COAGATAT2 * ( BM2IITT( N2N + 1)
     &           - BM2IITT( N2N ) ) * QS11_ADJ
      ELSE IF ( N2N == 10 ) THEN
         N2N_ADJ = N2N_ADJ + COAGATAT2 * ( BM2IITT( N2N )
     &           - BM2IITT( N2N - 1 ) ) * QS11_ADJ
      END IF
      QS11_ADJ = 0.0
      ...
      ! COAGATAT2 = CONSTII * I1_AT
      ! adj code:
      I1_AT_ADJ = I1_AT_ADJ + CONSTII * COAGATAT2_ADJ
      COAGATAT2_ADJ = 0.0
      ...
      ! I1_AT = ( I1NC_AT * I1FM_AT ) / ( I1NC_AT + I1FM_AT )
      ! adj code:
      I1NC_AT_ADJ = I1NC_AT_ADJ + ( I1FM_AT / ( I1NC_AT + I1FM_AT )
     &            - I1FM_AT * I1NC_AT / ( I1NC_AT + I1FM_AT ) ** 2.0 )
     &            * I1_AT_ADJ
      I1FM_AT_ADJ = I1FM_AT_ADJ + ( I1NC_AT / ( I1NC_AT + I1FM_AT )
     &            - I1FM_AT * I1NC_AT / ( I1NC_AT + I1FM_AT ) ** 2.0 )
     &            * I1_AT_ADJ
      I1_AT_ADJ = 0.0
      ...
      ! &      +  ESAT16 * ESAT01  )
      ! adj code:
      KFMAT_ADJ = KFMAT_ADJ + BM2II(N2N) * SQDGAT5 * ( ESAT25
     &          +  TWO * ESAT09 * ESAT04
     &          +  ESAT01 * ESAT16
     &          +  ESAT64 * ESAT09
     &          +  TWO * ESAT36 * ESAT01
     &          +  ESAT16 * ESAT01  ) * I1FM_AT_ADJ
      SQDGAT5_ADJ = SQDGAT5_ADJ + BM2II(N2N) * KFMAT * ( ESAT25
     &          +  TWO * ESAT09 * ESAT04
     &          +  ESAT01 * ESAT16
     &          +  ESAT64 * ESAT09
     &          +  TWO * ESAT36 * ESAT01
     &          +  ESAT16 * ESAT01  ) * I1FM_AT_ADJ
      ESAT25_ADJ = ESAT25_ADJ + KFMAT * SQDGAT5 * BM2II(N2N) * 
     &             I1FM_AT_ADJ
      ESAT04_ADJ = ESAT04_ADJ + KFMAT * SQDGAT5 * BM2II(N2N)
     &           * TWO * ESAT09 * I1FM_AT_ADJ
      ESAT09_ADJ = ESAT09_ADJ + KFMAT * SQDGAC5 * BM2II(N2N)
     &           * ( TWO * ESAT04 + ESAT64 ) * I1FM_AT_ADJ
      ESAT16_ADJ = ESAT16_ADJ + KFMAT * SQDGAT5 * BM2II(N2N)
     &           * 2.0 * ESAT01 * I1FM_AT_ADJ
      ESAT01_ADJ = ESAT01_ADJ + KFMAT * SQDGAT5 * BM2II(N2N)
     &           * ( 2.0 * ESAT16 + TWO * ESAT36 ) * I1FM_AT_ADJ
      ESAT64_ADJ = ESAT64_ADJ + KFMAT * SQDGAT5 * BM2II(N2N)
     &           * ESAT09 * I1FM_AT_ADJ
      ESAT36_ADJ = ESAT36_ADJ + KFMAT * SQDGAT5 * BM2II(N2N)
     &           * TWO * ESAT01 * I1FM_AT_ADJ
      IF ( N2N > 1 .AND. N2N < 10 ) THEN
         N2N_ADJ = N2N_ADJ+ KFMAT * SQDGAT5 * ( ESAT25
     &           +  TWO * ESAT09 * ESAT04
     &           +  ESAT01 * ESAT16
     &           +  ESAT64 * ESAT09
     &           +  TWO * ESAT36 * ESAT01
     &           +  ESAT16 * ESAT01  ) * ( ( BM2II( N2N + 1 )
     &           - BM2II( N2N - 1 ) ) / 2.0 ) * I1FM_AT_ADJ
      ELSE IF ( N2N == 1 ) THEN
         N2N_ADJ = N2N_ADJ+ KFMAT * SQDGAT5 * ( ESAT25
     &           +  TWO * ESAT09 * ESAT04
     &           +  ESAT01 * ESAT16
     ...
     &           +  ESAT64 * ESAT09
     &           +  TWO * ESAT36 * ESAT01
     &           +  ESAT16 * ESAT01  ) * ( BM2II( N2N )
     &           - BM2II( N2N - 1) ) * I1FM_AT_ADJ
      END IF
      I1FM_AT_ADJ = 0.0
      ...
      ! &     +     ESAT36 * ESAT16 )  )
      ! adj code:
      DGAT2_ADJ = DGAT2_ADJ + KNC * ( TWO * ESAT16 + ESAT04 * ESAT04
     &          + ESAT36 * ESAT04 + A * KNGAT * ( TWO * ESAT04
     &          + ESAT16 * ESAT04 + ESAT36 * ESAT16 ) ) * I1NC_AT_ADJ
      ESAT16_ADJ = ESAT16_ADJ + ( KNC * DGAT2 * TWO + KNC * DGAT2 * A
     &           * KNGAT * ( ESAT04 + ESAT36 ) ) * I1NC_AT_ADJ
      ESAT04_ADJ = ESAT04_ADJ + KNC * DGAT2 * ( 2.0 * ESAT04 + ESAT36 )
     &           + KNC * DGAT2 * A * KNGAT * ( TWO + ESAT16 ) * 
     &             I1NC_AT_ADJ
      ESAT36_ADJ = ESAT36_ADJ + KNC * DGAT2 * ESAT04 + KNC * DGAT2
     &           * A * KNGAT * ESAT16 * I1NC_AT_ADJ
      KNGAT_ADJ = KNGAT_ADJ + KNC * DGAT2 * A * ( TWO * ESAT04
     &          + ESAT16 * ESAT04 + ESAT36 * ESAT16 ) * I1NC_AT_ADJ
      I1NC_AT_ADJ = 0.0
      ...
      ! QN22 = COAGACAC0
      ! adj code:
      COAGACAC0_ADJ = COAGACAC0_ADJ + QN22_ADJ
      QN22_ADJ = 0.0
      ...
      ! COAGACAC0 = COAGFM_AC * COAGNC_AC / ( COAGFM_AC + COAGNC_AC )
      ! adj code:
      COAGFM_AC_ADJ = COAGFM_AC_ADJ + ( COAGNC_AC /
     &              ( COAGFM_AC + COAGNC_AC )
     &              - COAGFM_AC * COAGNC_AC / ( COAGFM_AC + COAGNC_AC )
     &              ** 2.0 ) * COAGACAC0_ADJ
      COAGNC_AC_ADJ = COAGNC_AC_ADJ + ( COAGFM_AC /
     &              ( COAGFM_AC + COAGNC_AC )
     &              - COAGFM_AC * COAGNC_AC / ( COAGFM_AC + COAGNC_AC )
     &              ** 2.0 ) * COAGACAC0_ADJ
      COAGACAC0_ADJ = 0.0
      ...
      !           * ( ESAC01 + ESAC25 * TWO * ESAC05 )
      ! adj code:
      KFMAC_ADJ = KFMAC_ADJ + SQDGAC * BM0(N2A) * ( ESAC01
     &          + ESAC25 + TWO * ESAC05 ) * COAGFM_AC_ADJ
      SQDGAC_ADJ = SQDGAC_ADJ + KFMAC * BM0(N2A) * ( ESAC01
     &           + ESAC25 + TWO * ESAC05 ) * COAGFM_AC_ADJ
      ESAC01_ADJ = ESAC01_ADJ + KFMAC * SQDGAC * BM0(N2A) * 
     &             COAGFM_AC_ADJ
      ESAC25_ADJ = ESAC25_ADJ + KFMAC * SQDGAC * BM0(N2A) * 
     &             COAGFM_AC_ADJ
      ESAC05_ADJ = ESAC05_ADJ + KFMAC * SQDGAC * BM0(N2A) * TWO
     &           * COAGFM_AC_ADJ
      IF ( N2A > 1 .AND. N2A < 10 ) THEN
         N2A_ADJ = N2A_ADJ + KFMAC * SQDGAC * ( ESAC01 + ESAC25
     &           * TWO * ESAC05 ) * ( ( BM0( N2A + 1 ) - BM0( N2A - 1 )
     &           ) / 2.0 ) * COAGFM_AC_ADJ
      ELSE IF ( N2A == 1 ) THEN
         N2A_ADJ = N2A_ADJ + KFMAC * SQDGAC * ( ESAC01 + ESAC25
     &           * TWO * ESAC05 ) * ( BM0( N2A + 1 ) - BM0( N2A ) )
     &           * COAGFM_AC_ADJ
      ELSE IF ( N2A == 10 ) THEN
         N2A_ADJ = N2A_ADJ + KFMAC * SQDGAC * ( ESAC01 + ESAC25
     &           * TWO * ESAC05 ) * ( BM0( N2A ) - BM0( N2A - 1 ) )
     &           * COAGFM_AC_ADJ
      END IF
      COAGFM_AC_ADJ = 0.0
      ...
      ! COAGNC_AC = KNC * ( ONE + ESAC08 + A * KNGAC * ( ESAC20 + ESAC04 ) )
      ! adj code:
      ESAC08_ADJ = ESAC08_ADJ + KNC * COAGNC_AC_ADJ
      KNGAC_ADJ = KNGAC_ADJ + KNC * A * ( ESAC20 + ESAC04 ) * 
     &           COAGNC_AC_ADJ
      ESAC20_ADJ = ESAC20_ADJ + KNC * A * KNGAC * COAGNC_AC_ADJ
      ESAC04_ADJ = ESAC04_ADJ + KNC * A * KNGAC * COAGNC_AC_ADJ
      COAGNC_AC_ADJ = 0.0
      ...
      ! QN11 = COAGATAT0
      ! adj code:
      COAGATAT0_ADJ = COAGATAT0_ADJ + QN11_ADJ
      QN11_ADJ = 0.0
      ...
      ! COAGATAT0 = COAGFM_AT * COAGNC_AT / ( COAGFM_AT + COAGNC_AT )
      ! adj code:
      COAGFM_AT_ADJ = COAGFM_AT_ADJ + ( COAGNC_AT /
     &              ( COAGFM_AT + COAGNC_AT )
     &              - COAGFM_AT * COAGNC_AT / ( COAGFM_AT + COAGNC_AT )
     &              ** 2.0 ) * COAGATAT0_ADJ
      COAGNC_AT_ADJ = COAGNC_AT_ADJ + ( COAGFM_AT /
     &              ( COAGFM_AT + COAGNC_AT )
     &              - COAGFM_AT * COAGNC_AT / ( COAGFM_AT + COAGNC_AT )
     &              ** 2.0 ) * COAGATAT0_ADJ
      COAGATAT0_ADJ = 0.0
      ...
      !           * ( ESAT01 + ESAT25 + TWO * ESAT05 )
      ! adj code:
      KFMAT_ADJ = KFMAT_ADJ + SQDGAT * BM0(N2N) * ( ESAT01
     &          + ESAT25 + TWO * ESAT05 ) * COAGFM_AT_ADJ
      SQDGAT_ADJ = SQDGAT_ADJ + KFMAT * BM0(N2N) * ( ESAT01
     &           + ESAT25 + TWO * ESAT05 ) * COAGFM_AT_ADJ
      ESAT01_ADJ = ESAT01_ADJ + KFMAT * SQDGAT * BM0(N2N) * 
     &             COAGFM_AT_ADJ
      ESAT25_ADJ = ESAT25_ADJ + KFMAT * SQDGAT * BM0(N2N) * 
     &             COAGFM_AT_ADJ
      ESAT05_ADJ = ESAT05_ADJ + KFMAT * SQDGAT * BM0(N2N) * TWO
     &           * COAGFM_AT_ADJ
      IF ( N2N > 1 .AND. N2N < 10 ) THEN
         N2N_ADJ = N2N_ADJ + KFMAT * SQDGAT * ( ESAT01 + ESAT25 + TWO
     &           * ESAT05 ) * ( ( BM0( N2N + 1 ) - BM0( N2N - 1 ) )
     &           / 2.0 ) * COAGFM_AT_ADJ
      ELSE IF ( N2N == 1 ) THEN
         N2N_ADJ = N2N_ADJ + KFMAT * SQDGAT * ( ESAT01 + ESAT25 + TWO
     &           * ESAT05 ) * ( BM0( N2N + 1 ) - BM0( N2N ) )
     &           * COAGFM_AT_ADJ
      ELSE IF ( N2N == 10 ) THEN
         N2N_ADJ = N2N_ADJ + KFMAT * SQDGAT * ( ESAT01 + ESAT25 + TWO
     &           * ESAT05 ) * ( BM0( N2N ) - BM0( N2N - 1 ) )
     &           * COAGFM_AT_ADJ
      END IF
      COAGFM_AT_ADJ = 0.0
      ...
      ! COAGNC_AT = KNC * ( ONE + ESAT08 + A * KNGAT * ( ESAT20 + ESAT04 ) )
      ! adj code:
      ESAT08_ADJ = ESAT08_ADJ + KNC * COAGNC_AT_ADJ
      KNGAT_ADJ = KNGAT_ADJ + KNC * A * ( ESAT20 + ESAT04 ) * 
     &            COAGNC_AT_ADJ
      ESAT20_ADJ = ESAT20_ADJ + KNC * A * KNGAT * COAGNC_AT_ADJ
      ESAT04_ADJ = ESAT04_ADJ + KNC * A * KNGAT * COAGNC_AT_ADJ
      COAGNC_AT_ADJ = 0.0
      ...
      ! QV12 = COAGATAC3
      ! adj code:
      COAGATAC3_ADJ = COAGATAC3_ADJ + QV12_ADJ
      QV12_ADJ = 0.0
      ...
      ! COAGATAC3 = COAGNC3 * COAGFM3 / ( COAGNC3 + COAGFM3 )
      ! adj code:
      COAGFM3_ADJ = COAGFM3_ADJ + ( COAGNC3 /
     &              ( COAGFM3 + COAGNC3 )
     &              - COAGFM3 * COAGNC3 / ( COAGFM3 + COAGNC3 )
     &              ** 2.0 ) * COAGATAC3_ADJ
      COAGNC3_ADJ = COAGNC3_ADJ + ( COAGFM3 /
     &              ( COAGFM3 + COAGNC3 )
     &              - COAGFM3 * COAGNC3 / ( COAGFM3 + COAGNC3 )
     &              ** 2.0 ) * COAGATAC3_ADJ
      COAGATAC3_ADJ = 0.0
      ...
      ! &        + TWO * RI1 * ESAT64  * ESAC01 )
      ! adj code:
      KFMATAC_ADJ = KFMATAC_ADJ + SQDGAT7 * BM3I( N1, N2N, N2A )
     &            * ( ESAT49 + R * ESAT36  * ESAC01
     &            + TWO * R2 * ESAT25  * ESAC04
     &            + R4 * ESAT09  * ESAC16
     &            + RI3 * ESAT100 * ESAC09
     &            + TWO * RI1 * ESAT64  * ESAC01 ) * COAGFM3_ADJ
      SQDGAT7_ADJ = SQDGAT7_ADJ + KFMATAC * BM3I( N1, N2N, N2A )
     &            * ( ESAT49 + R * ESAT36  * ESAC01
     &            + TWO * R2 * ESAT25  * ESAC04
     &            + R4 * ESAT09  * ESAC16
     &            + RI3 * ESAT100 * ESAC09
     &            + TWO * RI1 * ESAT64  * ESAC01 ) * COAGFM3_ADJ
      ESAT49_ADJ = ESAT49_ADJ + KFMATAC * SQDGAT7 * BM3I(N1,N2N,N2A)
     &           * COAGFM3_ADJ
      ESAC01_ADJ = ESAC01_ADJ + KFMATAC * SQDGAT7 * BM3I(N1,N2N,N2A)
     &           * ( R * ESAT36 + TWO * RI1 * ESAT64 ) * COAGFM3_ADJ
      ESAT36_ADJ = ESAT36_ADJ + KFMATAC * SQDGAT7 * BM3I(N1,N2N,N2A)
     &           * R * ESAC01 * COAGFM3_ADJ
      R_ADJ = R_ADJ + KFMATAC * SQDGAT7 * BM3I(N1,N2N,N2A)
     &      * ESAT36 * ESAC01 * COAGFM3_ADJ
      ESAC04_ADJ = ESAC04_ADJ + KFMATAC * SQDGAT7 * BM3I(N1,N2N,N2A)
     &           * TWO * R2 * ESAT25 * COAGFM3_ADJ
      ESAT25_ADJ = ESAT25_ADJ + KFMATAC * SQDGAT7 * BM3I(N1,N2N,N2A)
     &           * TWO * R2 * ESAC04 * COAGFM3_ADJ
      R2_ADJ = R2_ADJ + KFMATAC * SQDGAT7 * BM3I(N1,N2N,N2A)
     &       * TWO * ESAC04 * ESAT25 * COAGFM3_ADJ
      ESAC16_ADJ = ESAC16_ADJ + KFMATAC * SQDGAT7 * BM3I(N1,N2N,N2A)
     &           * R4 * ESAT09 * COAGFM3_ADJ
      ESAT09_ADJ = ESAT09_ADJ + KFMATAC * SQDGAT7 * BM3I(N1,N2N,N2A)
     &           * R4 * ESAC16 * COAGFM3_ADJ
      R4_ADJ = R4_ADJ + KFMATAC * SQDGAT7 * BM3I( N1, N2N, N2A )
     &       * ESAT09 * ESAC16 * COAGFM3_ADJ
      ESAC09_ADJ = ESAC09_ADJ + KFMATAC * SQDGAT7 * BM3I(N1,N2N,N2A)
     &           * RI3 * ESAT100 * COAGFM3_ADJ
      ESAT100_ADJ = ESAT100_ADJ + KFMATAC * SQDGAT7 * BM3I(N1,N2N,N2A)
     &            * RI3 * ESAC09 * COAGFM3_ADJ
      RI3_ADJ = RI3_ADJ + KFMATAC * SQDGAT7 * BM3I( N1, N2N, N2A )
     &        * ESAC09 * ESAT100 * COAGFM3_ADJ
      ESAT64_ADJ = ESAT64_ADJ + KFMATAC * SQDGAT7 * BM3I(N1,N2N,N2A)
     &           * TWO * RI1 * ESAC01 * COAGFM3_ADJ
      RI1_ADJ = RI1_ADJ + KFMATAC * SQDGAT7 * BM3I( N1, N2N, N2A )
     &        * ESAC01 * ESAT64 * COAGFM3_ADJ
      IF ( N1 > 1 .AND. N1 < 10 ) THEN
         N1_ADJ = N1_ADJ + SQDGAT7 * KFMATAC
     &          * ( ESAT49 + R * ESAT36  * ESAC01
     &          + TWO * R2 * ESAT25  * ESAC04
     &          + R4 * ESAT09  * ESAC16
     &          + RI3 * ESAT100 * ESAC09
     &          + TWO * RI1 * ESAT64 * ESAC01 )
     &          * ( ( BM3I( N1 + 1, N2N, N2A ) - BM3I( N1 - 1, N2N, N2A
     &          ) ) / 2.0 ) * COAGFM3_ADJ
      ELSE IF ( N1 == 1 ) THEN
         N1_ADJ = N1_ADJ + SQDGAT7 * KFMATAC
     &          * ( ESAT49 + R * ESAT36  * ESAC01
     ...
     &          + RI3 * ESAT100 * ESAC09
     &          + TWO * RI1 * ESAT64 * ESAC01 )
     &          * ( BM3I( N1 + 1, N2N, N2A ) - BM3I( N1, N2N, N2A ) )
     &          * COAGFM3_ADJ
      ELSE IF ( N1 == 10 ) THEN
         N1_ADJ = N1_ADJ + SQDGAT7 * KFMATAC
     &          * ( ESAT49 + R * ESAT36  * ESAC01
     ...
     &          + RI3 * ESAT100 * ESAC09
     &          + TWO * RI1 * ESAT64 * ESAC01 )
     &          * ( BM3I( N1 , N2N, N2A ) - BM3I( N1 - 1, N2N, N2A ) )
     &          * COAGFM3_ADJ
      END IF
      IF ( N2N > 1 .AND. N2N < 10 ) THEN
         N2N_ADJ = N2N_ADJ + SQDGAT7 * KFMATAC
     &          * ( ESAT49 + R * ESAT36  * ESAC01
     &          + TWO * R2 * ESAT25  * ESAC04
     &          + R4 * ESAT09  * ESAC16
     &          + RI3 * ESAT100 * ESAC09
     &          + TWO * RI1 * ESAT64 * ESAC01 )
     &          * ( ( BM3I( N1, N2N + 1, N2A ) - BM3I( N1, N2N - 1, N2A
     &          ) ) / 2.0 ) * COAGFM3_ADJ
      ELSE IF ( N2N == 1 ) THEN
         N2N_ADJ = N2N_ADJ + SQDGAT7 * KFMATAC
     &          * ( ESAT49 + R * ESAT36  * ESAC01
     ...
     &          + RI3 * ESAT100 * ESAC09
     &          + TWO * RI1 * ESAT64 * ESAC01 )
     &          * ( BM3I( N1, N2N + 1, N2A ) - BM3I( N1, N2N, N2A ) )
     &          * COAGFM3_ADJ
      ELSE IF ( N2N == 10 ) THEN
         N2N_ADJ = N2N_ADJ + SQDGAT7 * KFMATAC
     &          * ( ESAT49 + R * ESAT36  * ESAC01
     ...
     &          + RI3 * ESAT100 * ESAC09
     &          + TWO * RI1 * ESAT64 * ESAC01 )
     &          * ( BM3I( N1, N2N, N2A ) - BM3I( N1, N2N - 1, N2A ) )
     &          * COAGFM3_ADJ
      END IF
      IF ( N2A > 1 .AND. N2A < 10 ) THEN
         N2A_ADJ = N2A_ADJ + SQDGAT7 * KFMATAC
     &          * ( ESAT49 + R * ESAT36  * ESAC01
     &          + TWO * R2 * ESAT25  * ESAC04
     &          + R4 * ESAT09  * ESAC16
     &          + RI3 * ESAT100 * ESAC09
     &          + TWO * RI1 * ESAT64 * ESAC01 )
     &          * ( ( BM3I( N1, N2N, N2A + 1 ) - BM3I( N1, N2N, N2A - 1
     &          ) ) / 2.0 ) * COAGFM3_ADJ
      ELSE IF ( N2A == 1 ) THEN
         N2A_ADJ = N2A_ADJ + SQDGAT7 * KFMATAC
     &          * ( ESAT49 + R * ESAT36  * ESAC01
     ...
     &          + RI3 * ESAT100 * ESAC09
     &          + TWO * RI1 * ESAT64 * ESAC01 )
     &          * ( BM3I( N1, N2N, N2A + 1 ) - BM3I( N1, N2N, N2A ) )
     &          * COAGFM3_ADJ
      ELSE IF ( N2A == 10 ) THEN
         N2A_ADJ = N2A_ADJ + SQDGAT7 * KFMATAC
     &          * ( ESAT49 + R * ESAT36  * ESAC01
     ...
     &          + RI3 * ESAT100 * ESAC09
     &          + TWO * RI1 * ESAT64 * ESAC01 )
     &          * ( BM3I( N1, N2N, N2A ) - BM3I( N1, N2N, N2A - 1 ) )
     &          * COAGFM3_ADJ
      END IF
      COAGFM3_ADJ = 0.0
      ...
      ! &        + R2 * ESAT16 * ESAC04 + RI2 * ESAT64 * ESAC04 )
      ! adj code:
      DGAT3_ADJ = DGAT3_ADJ + KNC * ( TWO * ESAT36
     &          + A * KNGAT * ( ESAT16 + R2 * ESAT04 * ESAC04 )
     &          + A * KNGAC * ( ESAT36 * ESAC04 + RI2 * ESAT64 * ESAC16
     &          ) + R2 * ESAT16 * ESAC04 + RI2 * ESAT64 * ESAC04 )
     &          * COAGNC3_ADJ
      ESAT36_ADJ = ESAT36_ADJ + KNC * DGAT3 * ( TWO + A * KNGAC
     &           * ESAC04 ) * COAGNC3_ADJ
      KNGAT_ADJ = KNGAT_ADJ + KNC * DGAT3 * A * ( ESAT16 + R2 * ESAT04
     &          * ESAC04 ) * COAGNC3_ADJ
      ESAT16_ADJ = ESAT16_ADJ + KNC * DGAT3 * ( A * KNGAT + R2
     &           * ESAC04 ) * COAGNC3_ADJ
      R2_ADJ = R2_ADJ + KNC * DGAT3 * ( A * KNGAT * ESAT04 * ESAC04
     &       + ESAT16 * ESAC04 ) * COAGNC3_ADJ
      ESAT04_ADJ = ESAT04_ADJ + KNC * DGAT3 * A * KNGAT * R2 * ESAC04
     &           * COAGNC3_ADJ
      ESAC04_ADJ = ESAC04_ADJ + KNC * DGAT3 * ( A * KNGAT * R2
     &           * ESAT04 + A * KNGAC * ESAT36 + RI2 * ESAT64 )
     &           * COAGNC3_ADJ
      KNGAC_ADJ = KNGAC_ADJ + KNC * DGAT3 * A * ( ESAT36 * ESAC04
     &          + RI2 * ESAT64 * ESAC16 ) * COAGNC3_ADJ
      RI2_ADJ = RI2_ADJ + KNC * DGAT3 * ( A * KNGAC * ESAT64 * ESAC16
     &        + ESAT64 * ESAC04 ) * COAGNC3_ADJ
      ESAT64_ADJ = ESAT64_ADJ + KNC * DGAT3 * ( A * KNGAC * RI2 * ESAC16
     &           + RI2 * ESAC04 ) * COAGNC3_ADJ
      ESAC16_ADJ = ESAC16_ADJ + KNC * DGAT3 * A * KNGAC * RI2 * ESAT64
     &           * COAGNC3_ADJ
      COAGNC3_ADJ = 0.0
      ...
      ! QS21 = COAGACAT2 * BM2JI ( N1, N2N, N2A )
      ! adj code:
      COAGACAT2_ADJ = COAGACAT2_ADJ + BM2JI( N1, N2N, N2A ) * QS21_ADJ
      IF ( N1 > 1 .AND. N1 < 10 ) THEN
         N1_ADJ = N1_ADJ + COAGACAT2 * ( ( BM2JI( N1 + 1, N2N, N2A )
     &          - BM2JI( N1 - 1, N2N, N2A ) ) / 2.0 ) * QS21_ADJ
      ELSE IF ( N1 == 1 ) THEN
         N1_ADJ = N1_ADJ + COAGACAT2 * ( BM2JI( N1 + 1, N2N, N2A )
     &          - BM2JI( N1, N2N, N2A ) ) * QS21_ADJ
      ELSE IF ( N1 == 10 ) THEN
         N1_ADJ = N1_ADJ + COAGACAT2 * ( BM2JI( N1, N2N, N2A )
     &          - BM2JI( N1 - 1, N2N, N2A ) ) * QS21_ADJ
      END IF
      IF ( N2N > 1 .AND. N2N < 10 ) THEN
         N2N_ADJ = N2N_ADJ + COAGACAT2 * ( ( BM2JI( N1, N2N + 1, N2A )
     &           - BM2JI( N1, N2N - 1, N2A ) ) / 2.0 ) * QS21_ADJ
      ELSE IF ( N2N == 1 ) THEN
         N2N_ADJ = N2N_ADJ + COAGACAT2 * ( BM2JI( N1, N2N + 1, N2A )
     &           - BM2JI( N1, N2N, N2A ) ) * QS21_ADJ
      ELSE IF ( N2N == 10 ) THEN
         N2N_ADJ = N2N_ADJ + COAGACAT2 * ( BM2JI( N1, N2N, N2A )
     &           - BM2JI( N1, N2N - 1, N2A ) ) * QS21_ADJ
      END IF
      IF ( N2A > 1 .AND. N2A < 10 ) THEN
         N2A_ADJ = N2A_ADJ + COAGACAT2 * ( ( BM2JI( N1, N2N, N2A + 1 )
     &           - BM2JI( N1, N2N, N2A - 1 ) ) / 2.0 ) * QS21_ADJ
      ELSE IF ( N2A == 1 ) THEN
         N2A_ADJ = N2A_ADJ + COAGACAT2 * ( BM2JI( N1, N2N, N2A + 1 )
     &           - BM2JI( N1, N2N, N2A ) ) * QS21_ADJ
      ELSE IF ( N2A == 10 ) THEN
         N2A_ADJ = N2A_ADJ + COAGACAT2 * ( BM2JI( N1, N2N, N2A )
     &           - BM2JI( N1, N2N, N2A - 1 ) ) * QS21_ADJ
      END IF
      QS21_ADJ = 0.0
      ...
      ! COAGACAT2 = ( ( ONE + R6 ) ** TWO3RDS - R4 ) * I1
      ! adj code:
      I1_ADJ = I1_ADJ + ( ( ONE + R6 ) ** TWO3RDS - R4 ) * COAGACAT2_ADJ
      R4_ADJ = R4_ADJ - I1 * COAGACAT2_ADJ
      R6_ADJ = R6_ADJ + I1 * TWO3RDS * ( ONE + R6 ) ** ( TWO3RDS - 1.0 )
     &       * COAGACAT2_ADJ
      COAGACAT2_ADJ = 0.0
      ...
      ! QS12 = COAGATAC2
      ! adj code:
      COAGATAC2_ADJ = COAGATAC2_ADJ + QS12_ADJ
      QS12_ADJ = 0.0
      ...
      ! I1 = ( I1FM * I1NC ) / ( I1FM + I1NC )
      ! adj code:
      I1NC_ADJ = I1NC_ADJ + ( I1FM / ( I1NC + I1FM )
     &            - I1FM * I1NC / ( I1NC + I1FM ) ** 2.0 )
     &            * I1_ADJ
      I1FM_ADJ = I1FM_ADJ + ( I1NC / ( I1NC + I1FM )
     &            - I1FM * I1NC / ( I1NC + I1FM ) ** 2.0 )
     &            * I1_ADJ
      I1_ADJ = 0.0
      ...
      ! &      +  R * ESAT16 * ESAC01  )
      ! adj code:
      KFMATAC_ADJ = KFMATAC_ADJ + SQDGAT5 * BM2IJ( N1, N2N, N2A )
     &            * ( ESAT25 + TWO * R2 * ESAT09 * ESAC04
     &            + R4 * ESAT01 * ESAC16
     &            + RI3 * ESAT64 * ESAC09
     &            + TWO * RI1 * ESAT36 * ESAC01
     &            + R * ESAT16 * ESAC01 ) * I1FM_ADJ
      SQDGAT5_ADJ = SQDGAT5_ADJ + KFMATAC * BM2IJ( N1, N2N, N2A )
     &            * ( ESAT25 + TWO * R2 * ESAT09 * ESAC04
     &            + R4 * ESAT01 * ESAC16
     &            + RI3 * ESAT64 * ESAC09
     &            + TWO * RI1 * ESAT36 * ESAC01
     &            + R * ESAT16 * ESAC01 ) * I1FM_ADJ
      ESAT25_ADJ = ESAT25_ADJ + KFMATAC * SQDGAT5 * BM2IJ( N1, N2N, N2A 
     &           ) * I1FM_ADJ
      R2_ADJ = R2_ADJ + KFMATAC * SQDGAT5 * BM2IJ( N1, N2N, N2A )
     &       * TWO * ESAT09 * ESAC04 * I1FM_ADJ
      ESAT09_ADJ = ESAT09_ADJ + KFMATAC * SQDGAT5 * BM2IJ( N1, N2N, N2A 
     &           ) * TWO * R2 * ESAC04 * I1FM_ADJ
      ESAC04_ADJ = ESAC04_ADJ + KFMATAC * SQDGAT5 * BM2IJ( N1, N2N, N2A 
     &           ) * TWO * R2 * ESAT09 * I1FM_ADJ
      R4_ADJ = R4_ADJ + KFMATAC * SQDGAT5 * BM2IJ( N1, N2N, N2A )
     &       * ESAT01 * ESAC16 * I1FM_ADJ
      ESAT01_ADJ = ESAT01_ADJ + KFMATAC * SQDGAT5 * BM2IJ( N1, N2N, N2A 
     &           ) * R4 * ESAC16 * I1FM_ADJ
      ESAC16_ADJ = ESAC16_ADJ + KFMATAC * SQDGAT5 * BM2IJ( N1, N2N, N2A
     &           ) * R4 * ESAT01 * I1FM_ADJ
      RI3_ADJ = RI3_ADJ + KFMATAC * SQDGAT5 * BM2IJ( N1, N2N, N2A )
     &        * ESAT64 * ESAC09 * I1FM_ADJ
      ESAT64_ADJ = ESAT64_ADJ + KFMATAC * SQDGAT5 * BM2IJ( N1, N2N, N2A
     &           ) * RI3 * ESAC09 * I1FM_ADJ
      ESAC09_ADJ = ESAC09_ADJ + KFMATAC * SQDGAT5 * BM2IJ( N1, N2N, N2A
     &           ) * RI3 * ESAT64 * I1FM_ADJ
      RI1_ADJ = RI1_ADJ + KFMATAC * SQDGAT5 * BM2IJ( N1, N2N, N2A )
     &        * TWO * ESAT36 * ESAC01 * I1FM_ADJ
      ESAT36_ADJ = ESAT36_ADJ + KFMATAC * SQDGAT5 * BM2IJ( N1, N2N, N2A
     &           ) * TWO * RI1 * ESAC01 * I1FM_ADJ
      ESAC01_ADJ = ESAC01_ADJ + KFMATAC * SQDGAT5 * BM2IJ( N1, N2N, N2A
     &           ) * ( TWO * RI1 * ESAT36 + R * ESAT16 ) * I1FM_ADJ
      R_ADJ = R_ADJ + KFMATAC * SQDGAT5 * BM2IJ( N1, N2N, N2A )
     &      * ESAT16 * ESAC01 * I1FM_ADJ
      ESAT16_ADJ = ESAT16_ADJ + KFMATAC * SQDGAT5 * BM2IJ( N1, N2N, N2A 
     &           ) * R * ESAC01 * I1FM_ADJ
      IF ( N1 > 1 .AND. N1 < 10 ) THEN
         N1_ADJ = N1_ADJ + SQDGAT5 * KFMATAC
     &               * ( ESAT25 + TWO * R2 * ESAT09 * ESAC04
     &               + R4 * ESAT01 * ESAC16
     &               + RI3 * ESAT64 * ESAC09
     &               + TWO * RI1 * ESAT36 * ESAC01
     &               + R * ESAT16 * ESAC01 ) * ( ( BM2IJ( N1 + 1, N2N, 
     &               N2A ) - BM2IJ( N1 - 1, N2N, N2A ) ) / 2.0 ) * 
     &               I1FM_ADJ
      ELSE IF ( N1 == 1 ) THEN
         N1_ADJ = N1_ADJ + SQDGAT5 * KFMATAC
     &               * ( ESAT25 + TWO * R2 * ESAT09 * ESAC04
     ...
     &               + RI3 * ESAT64 * ESAC09
     &               + TWO * RI1 * ESAT36 * ESAC01
     &               + R * ESAT16 * ESAC01 ) * ( BM2IJ( N1 + 1, N2N, N2A
     &               ) - BM2IJ( N1, N2N, N2A ) ) * I1FM_ADJ
      ELSE IF ( N1 == 10 ) THEN
         N1_ADJ = N1_ADJ + SQDGAT5 * KFMATAC
     &               * ( ESAT25 + TWO * R2 * ESAT09 * ESAC04
     &               + R4 * ESAT01 * ESAC16
     &               + RI3 * ESAT64 * ESAC09
     &               + TWO * RI1 * ESAT36 * ESAC01
     &               + R * ESAT16 * ESAC01 ) * ( BM2IJ( N1, N2N, N2A )
     &               - BM2IJ( N1 - 1, N2N, N2A ) ) * I1FM_ADJ
      END IF
      IF ( N2N > 1 .AND. N2N < 10 ) THEN
         N2N_ADJ = N2N_ADJ + SQDGAT5 * KFMATAC
     &               * ( ESAT25 + TWO * R2 * ESAT09 * ESAC04
     &               + R4 * ESAT01 * ESAC16
     &               + RI3 * ESAT64 * ESAC09
     &               + TWO * RI1 * ESAT36 * ESAC01
     &               + R * ESAT16 * ESAC01 ) * ( ( BM2IJ( N1, N2N + 1, 
     &               N2A ) - BM2IJ( N1, N2N - 1, N2A ) ) / 2.0 ) * 
     &               I1FM_ADJ
      ELSE IF ( N2N == 1 ) THEN
         N2N_ADJ = N2N_ADJ + SQDGAT5 * KFMATAC
     &               * ( ESAT25 + TWO * R2 * ESAT09 * ESAC04
     ...
     &               + RI3 * ESAT64 * ESAC09
     &               + TWO * RI1 * ESAT36 * ESAC01
     &               + R * ESAT16 * ESAC01 ) * ( BM2IJ( N1, N2N + 1, N2A
     &               ) - BM2IJ( N1, N2N, N2A ) ) * I1FM_ADJ
      ELSE IF ( N2N == 10 ) THEN
         N2N_ADJ = N2N_ADJ + SQDGAT5 * KFMATAC
     &               * ( ESAT25 + TWO * R2 * ESAT09 * ESAC04
     ...
     &               + TWO * RI1 * ESAT36 * ESAC01
     &               + R * ESAT16 * ESAC01 ) * ( BM2IJ( N1, N2N, N2A )
     &               - BM2IJ( N1, N2N - 1, N2A ) ) * I1FM_ADJ
      END IF
      IF ( N2A > 1 .AND. N2A < 10 ) THEN
         N2A_ADJ = N2A_ADJ + SQDGAT5 * KFMATAC
     &               * ( ESAT25 + TWO * R2 * ESAT09 * ESAC04
     &               + R4 * ESAT01 * ESAC16
     &               + RI3 * ESAT64 * ESAC09
     &               + TWO * RI1 * ESAT36 * ESAC01
     &               + R * ESAT16 * ESAC01 ) * ( ( BM2IJ( N1, N2N, N2A +
     &               1 ) - BM2IJ( N1, N2N, N2A - 1 ) ) / 2.0 ) * 
     &               I1FM_ADJ
      ELSE IF ( N2A == 1 ) THEN
         N2A_ADJ = N2A_ADJ + SQDGAT5 * KFMATAC
     &               * ( ESAT25 + TWO * R2 * ESAT09 * ESAC04
     ...
     &               + RI3 * ESAT64 * ESAC09
     &               + TWO * RI1 * ESAT36 * ESAC01
     &               + R * ESAT16 * ESAC01 ) * ( BM2IJ( N1, N2N, N2A + 1
     &               ) - BM2IJ( N1, N2N, N2A ) ) * I1FM_ADJ
      ELSE IF ( N2A == 10 ) THEN
         N2A_ADJ = N2A_ADJ + SQDGAT5 * KFMATAC
     &               * ( ESAT25 + TWO * R2 * ESAT09 * ESAC04
     ...
     &               - BM2IJ( N1, N2N, N2A - 1 ) ) * I1FM_ADJ
      ...
      ! &     +     R2 * ESAC04 )  )
      ! adj code:
      DGAT2_ADJ = DGAT2_ADJ + KNC * ( TWO * ESAT16
     &          + R2 * ESAT04 * ESAC04
     &          + RI2 * ESAT36 * ESAC04
     &          + A * KNGAT * ( ESAT04
     &          + RI2 * ESAT16 * ESAC04
     &          + RI4 * ESAT36 * ESAC16
     &          + R2 * ESAC04 )  ) * I1NC_ADJ
      ESAT16_ADJ = ESAT16_ADJ + KNC * DGAT2 * ( A * KNGAT * RI2
     &           * ESAC04 + TWO ) * I1NC_ADJ
      R2_ADJ = R2_ADJ + KNC * DGAT2 * ( ESAT04 * ESAC04 + A * KNGAT
     &       * ESAC04 ) * I1NC_ADJ
      ESAT04_ADJ = ESAT04_ADJ + KNC * DGAT2 * ( R2 * ESAC04
     &           + A * KNGAT ) * I1NC_ADJ
      ESAC04_ADJ = ESAC04_ADJ + KNC * DGAT2 * ( R2 * ESAT04
     &           + RI2 * ESAT36 + A * KNGAT * ( RI2 * ESAT16 + R2 ) )
     &           * I1NC_ADJ
      RI2_ADJ = RI2_ADJ + KNC * DGAT2 * ( ESAT36 * ESAC04
     &        + A * KNGAT * ESAT16 * ESAC04 ) * I1NC_ADJ
      ESAT36_ADJ = ESAT36_ADJ + KNC * DGAT2 * ( RI2 * ESAC04
     &        + A * KNGAT * RI4 * ESAC16 ) * I1NC_ADJ
      KNGAT_ADJ = KNGAT_ADJ + KNC * DGAT2 * ( ESAT04 + RI2
     &          * ESAT16 * ESAC04 + RI4 * ESAT36 * ESAC16
     &          + R2 * ESAC04 ) * I1NC_ADJ
      RI4_ADJ = RI4_ADJ + KNC * DGAT2 * A * KNGAT * ESAT36 * ESAC16
     &        * I1NC_ADJ
      ESAC16_ADJ = ESAC16_ADJ + KNC * DGAT2 * A * KNGAT * RI4
     &           * ESAT36 * I1NC_ADJ
      I1NC_ADJ = 0.0
      ...
      ! QN12 = COAGATAC0
      ! adj code:
      COAGATAC0_ADJ = COAGATAC0_ADJ + QN12_ADJ
      QN12_ADJ = 0.0
      ...
      ! COAGATAC0 = COAGNC0 * COAGFM0 / ( COAGNC0 + COAGFM0 )
      ! adj code:
      COAGFM0_ADJ = COAGFM0_ADJ + ( COAGNC0 /
     &              ( COAGFM0 + COAGNC0 )
     &              - COAGFM0 * COAGNC0 / ( COAGFM0 + COAGNC0 )
     &              ** 2.0 ) * COAGATAC0_ADJ
      COAGNC0_ADJ = COAGNC0_ADJ + ( COAGFM0 /
     &              ( COAGFM0 + COAGNC0 )
     &              - COAGFM0 * COAGNC0 / ( COAGFM0 + COAGNC0 )
     &              ** 2.0 ) * COAGATAC0_ADJ
      COAGATAC0_ADJ = 0.0
      ...
      ! &           + TWO * RI1 * ESAT04 + ESAC01  )
      ! adj code:
      KFMATAC_ADJ = KFMATAC_ADJ + SQDGAT * BM0IJ( N1, N2N, N2A )
     &            * ( ESAT01 + R * ESAC01 + TWO * R2 * ESAT01 * ESAC04
     &            + R4 * ESAT09 * ESAC16 + RI3 * ESAT16 * ESAC09
     &            + TWO * RI1 * ESAT04 + ESAC01  ) * COAGFM0_ADJ
      SQDGAT_ADJ = SQDGAT_ADJ + KFMATAC * BM0IJ( N1, N2N, N2A )
     &            * ( ESAT01 + R * ESAC01 + TWO * R2 * ESAT01 * ESAC04
     &            + R4 * ESAT09 * ESAC16 + RI3 * ESAT16 * ESAC09
     &            + TWO * RI1 * ESAT04 + ESAC01  ) * COAGFM0_ADJ
      ESAT01_ADJ = ESAT01_ADJ + KFMATAC * SQDGAT * BM0IJ( N1, N2N, N2A )
     &           * ( 1 + TWO * R2 * ESAC04 ) * COAGFM0_ADJ
      R_ADJ = R_ADJ + KFMATAC * SQDGAT * BM0IJ( N1, N2N, N2A )
     &      * ESAC01 * COAGFM0_ADJ
      ESAC01_ADJ = ESAC01_ADJ + KFMATAC * SQDGAT * BM0IJ( N1, N2N, N2A )
     &           * ( 1 + R ) * COAGFM0_ADJ
      R2_ADJ = R2_ADJ + KFMATAC * SQDGAT * BM0IJ( N1, N2N, N2A )
     &       * TWO * ESAT01 * ESAC04 * COAGFM0_ADJ
      ESAC04_ADJ = ESAC04_ADJ + KFMATAC * SQDGAT * BM0IJ( N1, N2N, N2A )
     &           * TWO * R2 * ESAT01 * COAGFM0_ADJ
      R4_ADJ = R4_ADJ + KFMATAC * SQDGAT * BM0IJ( N1, N2N, N2A )
     &       * ESAT09 * ESAC16 * COAGFM0_ADJ
      ESAT09_ADJ = ESAT09_ADJ + KFMATAC * SQDGAT * BM0IJ( N1, N2N, N2A )
     &           * R4 * ESAC16 * COAGFM0_ADJ
      ESAC16_ADJ = ESAC16_ADJ + KFMATAC * SQDGAT * BM0IJ( N1, N2N, N2A )
     &           * R4 * ESAT09 * COAGFM0_ADJ
      RI3_ADJ = RI3_ADJ + KFMATAC * SQDGAT * BM0IJ( N1, N2N, N2A )
     &        * ESAT16 * ESAC09 * COAGFM0_ADJ
      ESAT16_ADJ = ESAT16_ADJ + KFMATAC * SQDGAT * BM0IJ( N1, N2N, N2A )
     &           * RI3 * ESAC09 * COAGFM0_ADJ
      ESAC09_ADJ = ESAC09_ADJ + KFMATAC * SQDGAT * BM0IJ( N1, N2N, N2A )
     &           * RI3 * ESAT16 * COAGFM0_ADJ
      RI1_ADJ = RI1_ADJ + KFMATAC * SQDGAT * BM0IJ( N1, N2N, N2A )
     &        * TWO * ESAT04 * ESAC01 * COAGFM0_ADJ
      ESAT04_ADJ = ESAT04_ADJ + KFMATAC * SQDGAT * BM0IJ( N1, N2N, N2A )
     &           * TWO * RI1 * ESAC01 * COAGFM0_ADJ
      IF ( N1 > 1 .AND. N1 < 10 ) THEN
         N1_ADJ = N1_ADJ + SQDGAT * KFMATAC
     &               * ( ESAT01 + R * ESAC01 + TWO * R2 * ESAT01 * 
     &               ESAC04 + R4 * ESAT09 * ESAC16 + RI3 * ESAT16 * 
     &               ESAC09 + TWO * RI1 * ESAT04 + ESAC01  ) * ( (
     &               BM0IJ( N1 + 1, N2N, N2A ) - BM0IJ( N1 - 1, N2N, N2A
     &               ) ) / 2.0 ) * COAGFM0_ADJ
      ELSE IF ( N1 == 1 ) THEN
         N1_ADJ = N1_ADJ + SQDGAT * KFMATAC
     &               * ( ESAT01 + R * ESAC01 + TWO * R2 * ESAT01 * 
     &               ESAC04 + R4 * ESAT09 * ESAC16 + RI3 * ESAT16 * 
     &               ESAC09 + TWO * RI1 * ESAT04 + ESAC01  ) * (
     &               BM0IJ( N1 + 1, N2N, N2A ) - BM0IJ( N1, N2N, N2A ) )
     &               * COAGFM0_ADJ
      ELSE IF ( N1 == 10 ) THEN
         N1_ADJ = N1_ADJ + SQDGAT * KFMATAC
     &              * ( ESAT01 + R * ESAC01 + TWO * R2 * ESAT01 * ESAC04
     &              + R4 * ESAT09 * ESAC16 + RI3 * ESAT16 * ESAC09
     &              + TWO * RI1 * ESAT04 + ESAC01  ) * (
     &              BM0IJ( N1, N2N, N2A ) - BM0IJ( N1 - 1, N2N, N2A ) )
     &              * COAGFM0_ADJ
      END IF
      IF ( N2N > 1 .AND. N2N < 10 ) THEN
         N2N_ADJ = N2N_ADJ + SQDGAT * KFMATAC
     &              * ( ESAT01 + R * ESAC01 + TWO * R2 * ESAT01 * ESAC04
     &              + R4 * ESAT09 * ESAC16 + RI3 * ESAT16 * ESAC09
     &              + TWO * RI1 * ESAT04 + ESAC01  ) * ( (
     &              BM0IJ( N1, N2N + 1, N2A ) - BM0IJ( N1, N2N - 1, N2A
     &              ) ) / 2.0 ) * COAGFM0_ADJ
      ELSE IF ( N2N == 1 ) THEN
         N2N_ADJ = N2N_ADJ + SQDGAT * KFMATAC
     &              * ( ESAT01 + R * ESAC01 + TWO * R2 * ESAT01 * ESAC04
     &              + R4 * ESAT09 * ESAC16 + RI3 * ESAT16 * ESAC09
     &              + TWO * RI1 * ESAT04 + ESAC01  ) * (
     &              BM0IJ( N1, N2N + 1, N2A ) - BM0IJ( N1, N2N, N2A ) )
     &              * COAGFM0_ADJ
      ELSE IF ( N2N == 10 ) THEN
         N2N_ADJ = N2N_ADJ + SQDGAT * KFMATAC
     &              * ( ESAT01 + R * ESAC01 + TWO * R2 * ESAT01 * ESAC04
     &              + R4 * ESAT09 * ESAC16 + RI3 * ESAT16 * ESAC09
     &              + TWO * RI1 * ESAT04 + ESAC01  ) * (
     &              BM0IJ( N1, N2N, N2A ) - BM0IJ( N1, N2N - 1, N2A ) )
     &              * COAGFM0_ADJ
      END IF
      IF ( N2A > 1 .AND. N2A < 10 ) THEN
         N2A_ADJ = N2A_ADJ + SQDGAT * KFMATAC
     &              * ( ESAT01 + R * ESAC01 + TWO * R2 * ESAT01 * ESAC04
     &              + R4 * ESAT09 * ESAC16 + RI3 * ESAT16 * ESAC09
     &              + TWO * RI1 * ESAT04 + ESAC01  ) * ( (
     &              BM0IJ( N1, N2N, N2A + 1 ) - BM0IJ( N1, N2N, N2A - 1
     &              ) ) / 2.0 ) * COAGFM0_ADJ
      ELSE IF ( N2A == 1 ) THEN
         N2A_ADJ = N2A_ADJ + SQDGAT * KFMATAC
     &              * ( ESAT01 + R * ESAC01 + TWO * R2 * ESAT01 * ESAC04
     ...
     &              * COAGFM0_ADJ
      ...
      ! &              + ( R2 + RI2 ) * ESAT04 * ESAC04  )
      ! adj code:
      KNGAT_ADJ = KNGAT_ADJ + KNC * A * ( ESAT04 + R2 * ESAT16
     &          * ESAC04 ) * COAGNC0_ADJ
      ESAT04_ADJ = ESAT04_ADJ + KNC * ( A * KNGAT + A * KNGAC
     &           * RI2 * ESAC16 + ( R2 + RI2 ) * ESAC04 ) * COAGNC0_ADJ
      R2_ADJ = R2_ADJ + KNC * ( A * KNGAT * ESAT16 * ESAC04 + ESAT04
     &       * ESAC04 ) * COAGNC0_ADJ
      ESAT16_ADJ = ESAT16_ADJ + KNC * A * KNGAT * R2 * ESAC04
     &           * COAGNC0_ADJ
      ESAC04_ADJ = ESAC04_ADJ + KNC * ( A * KNGAT * R2 * ESAT16
     &           + A * KNGAC + ( R2 + RI2 ) * ESAT04 ) * COAGNC0_ADJ
      KNGAC_ADJ = KNGAC_ADJ + KNC * A * ( ESAC04 + RI2 * ESAC16
     &          * ESAT04 ) * COAGNC0_ADJ
      RI2_ADJ = RI2_ADJ + KNC * ( A * KNGAC * ESAC16 * ESAT04
     &        + ESAT04 * ESAC04 ) * COAGNC0_ADJ
      ESAC16_ADJ = ESAC16_ADJ + KNC * A * KNGAC * RI2 * ESAT04
     &           * COAGNC0_ADJ
      COAGNC0_ADJ = 0.0
      ...
      ! &       1 + NINT( DLGSQT2 * LOG( RAT ) ) ) )
      ! adj code:
      temp = 1 + NINT( DLGSQT2 * LOG( RAT ) )
      IF ( ( temp < 10 ) .AND. ( temp >= 1 ) ) THEN
         RAT_ADJ = RAT_ADJ + 1 / RAT * N1_ADJ
      END IF
      N1_ADJ = 0.0
      ...
      ! &     NINT( 4.0 * ( SGACC - 0.75D0 ) ) ) )
      ! adj code:
      temp = NINT( 4.0 * ( SGACC - 0.75D0 ) )
      IF ( ( temp < 10 ) .AND. ( temp >= 1 ) ) THEN
         SGACC_ADJ = SGACC_ADJ + 4.0 * N2A_ADJ
      END IF
      N2A_ADJ = 0.0
      ...
      ! &      NINT( 4.0 * ( SGATK - 0.75D0 ) ) ) )
      ! adj code:
      temp = NINT( 4.0 * ( SGATK - 0.75D0 ) )
      IF ( ( temp >= 1 ) .AND. ( temp < 10 ) ) THEN
         SGATK_ADJ = SGATK_ADJ + 4.0 * N2N_ADJ
      END IF
      N2N_ADJ = 0.0
      ...
      ! RAT = DGACC / DGATK
      ! adj code:
      DGACC_ADJ = DGACC_ADJ + ( 1.0 / DGATK ) * RAT_ADJ
      DGATK_ADJ = DGATK_ADJ - DGACC / ( DGATK ** 2.0 ) * RAT_ADJ
      RAT_ADJ = 0.0
      ...
      ! KNGAC   = TWO * LAMDA / DGACC
      ! adj code:
      DGACC_ADJ = DGACC_ADJ - TWO * LAMDA / ( DGACC ** 2.0 ) * KNGAC_ADJ
      KNGAC_ADJ = 0.0
      DGATK_ADJ = DGATK_ADJ - TWO * LAMDA / ( DGATK ** 2.0 ) * KNGAT_ADJ
      KNGAT_ADJ = 0.0
      RI2_ADJ = RI2_ADJ + 2.0 * RI2 * RI4_ADJ
      RI4_ADJ = 0.0
      R3_ADJ = R3_ADJ - ONE / ( R3 ** 2.0 ) * RI3_ADJ
      RI3_ADJ = 0.0
      R2_ADJ = R2_ADJ - ONE / ( R2 ** 2.0 ) * RI2_ADJ
      RI2_ADJ = 0.0
      R_ADJ = R_ADJ - ONE / ( R ** 2.0 ) * RI1_ADJ
      RI1_ADJ = 0.0
      R4_ADJ = R4_ADJ + 2.0 * R4 * R8_ADJ
      R8_ADJ = 0.0
      R3_ADJ = R3_ADJ + 2.0 * R3 * R6_ADJ
      R6_ADJ = 0.0
      R3_ADJ = R3_ADJ + R2 * R5_ADJ
      R2_ADJ = R2_ADJ + R3 * R5_ADJ
      R5_ADJ = 0.0
      R2_ADJ = R2_ADJ + 2.0 * R2 * R4_ADJ
      R4_ADJ = 0.0
      R2_ADJ = R2_ADJ + R * R3_ADJ
      R_ADJ = R_ADJ + R2 * R3_ADJ
      R3_ADJ = 0.0
      R_ADJ = R_ADJ + 2.0 * R * R2_ADJ
      R2_ADJ = 0.0
      SQDGAC_ADJ = SQDGAC_ADJ + ( 1.0 / SQDGAT ) * R_ADJ
      SQDGAT_ADJ = SQDGAT_ADJ - SQDGAC / ( SQDGAT ** 2.0 ) * R_ADJ
      R_ADJ = 0.0
      ...
      ! XM3AC = DGAC3 * ESAC36
      ! adj code:
      DGAC3_ADJ = DGAC3_ADJ + ESAC36 * XM3AC_ADJ
      ESAC36_ADJ = ESAC36_ADJ + DGAC3 * XM3AC_ADJ
      XM3AC_ADJ = 0.0
      DGAC2_ADJ = DGAC2_ADJ + ESAC16 * XM2AC_ADJ
      ESAC16_ADJ = ESAC16_ADJ + DGAC2 * XM2AC_ADJ
      XM2AC_ADJ = 0.0
      ...
      ! XM3AT = DGAT3 * ESAT36
      ! adj code:
      DGAT3_ADJ = DGAT3_ADJ + ESAT36 * XM3AT_ADJ
      ESAT36_ADJ = ESAT36_ADJ + DGAT3 * XM3AT_ADJ
      XM3AT_ADJ = 0.0
      DGAT2_ADJ = DGAT2_ADJ + ESAT16 * XM2AT_ADJ
      ESAT16_ADJ = ESAT16_ADJ + DGAT2 * XM2AT_ADJ
      XM2AT_ADJ = 0.0
      ...
      ! SQDGAT7 = DGAT3 * SQDGAT
      ! adj code:
      DGAT3_ADJ = DGAT3_ADJ + SQDGAT * SQDGAT7_ADJ
      SQDGAT_ADJ = SQDGAT_ADJ + DGAT3 * SQDGAT7_ADJ
      SQDGAT7_ADJ = 0.0
      DGAC2_ADJ = DGAC2_ADJ + SQDGAC * SQDGAC5_ADJ
      SQDGAC_ADJ = SQDGAC_ADJ + DGAC2 * SQDGAC5_ADJ
      SQDGAC5_ADJ = 0.0
      DGAT2_ADJ = DGAT2_ADJ + SQDGAT * SQDGAT5_ADJ
      SQDGAT_ADJ = SQDGAT_ADJ + DGAT2 * SQDGAT5_ADJ
      SQDGAT5_ADJ = 0.0
      IF ( DGACC /= 0.0 ) THEN
         DGACC_ADJ = DGACC_ADJ + ( 1.0/2.0 ) * DGACC ** ( -1.0/2.0 )
     &          * SQDGAC_ADJ
      END IF
      IF ( DGATK /= 0.0 ) THEN
         DGATK_ADJ = DGATK_ADJ + ( 1.0/2.0 ) * DGATK ** ( -1.0/2.0 )
     &          * SQDGAT_ADJ
      END IF
      SQDGAC_ADJ = 0.0
      SQDGAT_ADJ = 0.0
      ...
      ! DGAC3   = DGACC * DGACC * DGACC
      ! adj code:
      DGACC_ADJ = DGACC_ADJ + 3.0 * DGACC * DGACC * DGAC3_ADJ
      DGAC3_ADJ = 0.0
      DGACC_ADJ = DGACC_ADJ + 2.0 * DGACC * DGAC2_ADJ
      DGAC2_ADJ = 0.0
      DGATK_ADJ = DGATK_ADJ + 3.0 * ( DGATK ** 2.0 ) * DGAT3_ADJ
      DGAT3_ADJ = 0.0
      DGATK_ADJ = DGATK_ADJ + 2.0 * DGATK * DGAT2_ADJ
      DGAT2_ADJ = 0.0
      ...
      ! ESAT100 = ESAT64 * ESAT36
      ! adj code:
      ESAT64_ADJ = ESAT64_ADJ + ESAT36 * ESAT100_ADJ
      ESAT36_ADJ = ESAT36_ADJ + ESAT64 * ESAT100_ADJ
      ESAT100_ADJ = 0.0
      ...
      ! ESAC64  = ESAC20 * ESAC20 * ESAC24
      ! adj code:
      ESAC20_ADJ = ESAC20_ADJ + 2.0 * ESAC20 * ESAC24 * ESAC64_ADJ
      ESAC24_ADJ = ESAC24_ADJ + ESAC20 * ESAC20 * ESAC64_ADJ
      ESAC64_ADJ = 0.0
      ESAT20_ADJ = ESAT20_ADJ + 2.0 * ESAT20 * ESAT24 * ESAT64_ADJ
      ESAT24_ADJ = ESAT24_ADJ + ESAT20 * ESAT20 * ESAT64_ADJ
      ESAT64_ADJ = 0.0
      ...
      ! ESAT49  = ESAT24 * ESAT25
      ! adj code:
      ESAT24_ADJ = ESAT24_ADJ + ESAT25 * ESAT49_ADJ
      ESAT25_ADJ = ESAT25_ADJ + ESAT24 * ESAT49_ADJ
      ESAT49_ADJ = 0.0
      ...
      ! ESAC36  = ESAC20 * ESAC16
      ! adj code:
      ESAC20_ADJ = ESAC20_ADJ + ESAC16 * ESAC36_ADJ
      ESAC16_ADJ = ESAC16_ADJ + ESAC20 * ESAC36_ADJ
      ESAC36_ADJ = 0.0
      ESAT20_ADJ = ESAT20_ADJ + ESAT16 * ESAT36_ADJ
      ESAT16_ADJ = ESAT16_ADJ + ESAT20 * ESAT36_ADJ
      ESAT36_ADJ = 0.0
      ...
      ! ESAC25  = ESAC20 * ESAC05
      ! adj code:
      ESAC20_ADJ = ESAC20_ADJ + ESAC05 * ESAC25_ADJ
      ESAC05_ADJ = ESAC05_ADJ + ESAC20 * ESAC25_ADJ
      ESAC25_ADJ = 0.0
      ESAT20_ADJ = ESAT20_ADJ + ESAT05 * ESAT25_ADJ
      ESAT05_ADJ = ESAT05_ADJ + ESAT20 * ESAT25_ADJ
      ESAT25_ADJ = 0.0
      ...
      ! ESAC24  = ESAC20 * ESAC04
      ! adj code:
      ESAC20_ADJ = ESAC20_ADJ + ESAC04 * ESAC24_ADJ
      ESAC04_ADJ = ESAC04_ADJ + ESAC20 * ESAC24_ADJ
      ESAC24_ADJ = 0.0
      ESAT20_ADJ = ESAT20_ADJ + ESAT04 * ESAT24_ADJ
      ESAT04_ADJ = ESAT04_ADJ + ESAT20 * ESAT24_ADJ
      ESAT24_ADJ = 0.0
      ...
      ! ESAC20  = ESAC16 * ESAC04
      ! adj code:
      ESAC16_ADJ = ESAC16_ADJ + ESAC04 * ESAC20_ADJ
      ESAC04_ADJ = ESAC04_ADJ + ESAC16 * ESAC20_ADJ
      ESAC20_ADJ = 0.0
      ESAT16_ADJ = ESAT16_ADJ + ESAT04 * ESAT20_ADJ
      ESAT04_ADJ = ESAT04_ADJ + ESAT16 * ESAT20_ADJ
      ESAT20_ADJ = 0.0
      ...
      ! ESAC16  = ESAC08 * ESAC08
      ! adj code:
      ESAC08_ADJ = ESAC08_ADJ + 2.0 * ESAC08 * ESAC16_ADJ
      ESAC16_ADJ = 0.0
      ESAT08_ADJ = ESAT08_ADJ + 2.0 * ESAT08 * ESAT16_ADJ
      ESAT16_ADJ = 0.0
      ...
      ! ESAC09  = ESAC08 * ESAC01
      ! adj code:
      ESAC08_ADJ = ESAC08_ADJ + ESAC01 * ESAC09_ADJ
      ESAC01_ADJ = ESAC01_ADJ + ESAC08 * ESAC09_ADJ
      ESAC09_ADJ = 0.0
      ESAT08_ADJ = ESAT08_ADJ + ESAT01 * ESAT09_ADJ
      ESAT01_ADJ = ESAT01_ADJ + ESAT08 * ESAT09_ADJ
      ESAT09_ADJ = 0.0
      ...
      ! ESAC08  = ESAC04 * ESAC04
      ! adj code:
      ESAC04_ADJ = ESAC04_ADJ + 2.0 * ESAC04 * ESAC08_ADJ
      ESAC08_ADJ = 0.0
      ESAT04_ADJ = ESAT04_ADJ + 2.0 * ESAT04 * ESAT08_ADJ
      ESAT08_ADJ = 0.0
      ...
      ! ESAC05  = ESAC04 * ESAC01
      ! adj code:
      ESAC04_ADJ = ESAC04_ADJ + ESAC01 * ESAC05_ADJ
      ESAC01_ADJ = ESAC01_ADJ + ESAC04 * ESAC05_ADJ
      ESAC05_ADJ = 0.0
      ESAT04_ADJ = ESAT04_ADJ + ESAT01 * ESAT05_ADJ
      ESAT01_ADJ = ESAT01_ADJ + ESAT04 * ESAT05_ADJ
      ESAT05_ADJ = 0.0
      ...
      ! ESAC04  = ESAC01 ** 4
      ! adj code:
      ESAC01_ADJ = ESAC01_ADJ + 4.0 * ( ESAC01 ** 3.0 ) * ESAC04_ADJ
      ESAC04_ADJ = 0.0
      ESAT01_ADJ = ESAT01_ADJ + 4.0 * ( ESAT01 ** 3.0 ) * ESAT04_ADJ
      ESAT04_ADJ = 0.0
      ...
      ! ESAC01   = EXP( 0.125D0 * XXLSGAC * XXLSGAC )
      ! adj code:
      XXLSGAC_ADJ = XXLSGAC_ADJ + 0.25D0 * XXLSGAC * EXP( 0.125D0
     &            * XXLSGAC * XXLSGAC ) * ESAC01_ADJ
      ESAC01_ADJ = 0.0
      XXLSGAT_ADJ = XXLSGAT_ADJ + 0.25D0 * XXLSGAT * EXP( 0.125D0
     &            * XXLSGAT * XXLSGAT ) * ESAT01_ADJ
      ESAT01_ADJ = 0.0
